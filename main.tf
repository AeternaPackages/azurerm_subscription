...
module "subscriptions" {
  source        = "git::https://github.com/AeternaModules/azurerm_subscription.git?ref=v5.0.1"
  subscriptions = local.subscriptions
}

module "subscription_cost_management_exports" {
  source                               = "git::https://github.com/AeternaModules/azurerm_subscription_cost_management_export.git?ref=v5.0.1"
...
module "subscription_cost_management_views" {
  source                             = "git::https://github.com/AeternaModules/azurerm_subscription_cost_management_view.git?ref=v5.0.1"
  subscription_cost_management_views = local.subscription_cost_management_views
  depends_on                         = [module.subscriptions]
}

module "subscription_policy_assignments" {
  source                          = "git::https://github.com/AeternaModules/azurerm_subscription_policy_assignment.git?ref=v5.0.1"
  subscription_policy_assignments = local.subscription_policy_assignments
  depends_on                      = [module.subscriptions]
}

module "subscription_policy_exemptions" {
  source                         = "git::https://github.com/AeternaModules/azurerm_subscription_policy_exemption.git?ref=v5.0.1"
...
module "subscription_policy_remediations" {
  source                           = "git::https://github.com/AeternaModules/azurerm_subscription_policy_remediation.git?ref=v5.0.1"
